...
def sendSticker(chat_id: int, sticker_id: str) -> dict:
    return makeRequest("sendSticker", chat_id=chat_id, sticker=sticker_id)


def sendPhoto(chat_id: int, photo_id: str) -> dict:
    return makeRequest("sendPhoto", chat_id=chat_id, photo=photo_id)
